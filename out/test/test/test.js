...
const specificityCalculator_1 = require("../src/specificityCalculator");
// 简单测试函数
function test(selector, expected) {
    const result = specificityCalculator_1.SpecificityCalculator.calculate(selector);
...
let passedTests = 0;
let totalTests = 0;
function runTest(selector, expected) {
    totalTests++;
